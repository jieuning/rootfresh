...
//mobile
import MobSearchResultHeader from "../../components/mobile/header/mobSearchResultHeader";
  ...
  return (
    <>
      ...
      <section style={{ paddingTop: "43px" }}>
        ...
        <h2 className="main-title">'{initKeyword}'에 대한 검색 결과</h2>
        ...
        {searchFilter.length !== 0 && initKeyword !== "" ?
          ...
          <div style={{ margin: "180px 0", textAlign: "center" }}>
            <img src={process.env.PUBLIC_URL + '/image/search_icon_g.png'} alt="검색 아이콘" />
